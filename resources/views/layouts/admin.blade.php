                ...
                <nav class="bg-dark-blue shadow-lg">
                    <div class="mx-auto sm:px-6 lg:px-8">
                        <div class="relative flex items-center justify-between md:justify-end h-16 ">
                            ...
                            <!-- Menu hamburger -->
                                <button type="button" @click="open = !open" @click.away="open = false" class="inline-flex items-center justify-center p-2 ml-2 rounded-md text-light-blue hover:bg-blue focus:outline-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="block w-6 h-6">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                <x-dropdown align="right" width="48">
                                    ...
                                    <x-slot name="trigger">
                                        <button class="flex items-center text-sm font-medium text-light-blue bg-dark-blue hover:bg-blue px-3 py-2 mr-2 rounded-md focus:outline-none transition ease-in-out duration-200">
