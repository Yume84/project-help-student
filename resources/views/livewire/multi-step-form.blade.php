<div>
    ...
    @if ($currentStep ==1)
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 sm:gap-2 md:gap-8 pt-10 pb-14">
    ...
    @if ($currentStep ==2)
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 sm:gap-2 md:gap-8 pt-10 pb-14">
    ...
    @if ($currentStep ==3)
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 sm:gap-2 md:gap-8 pt-10 pb-14">
            ...
            <x-input-error :messages="$errors->get('helps')" class="mt-2" />
    ...
    <div class="checkbox">
        <input id="rgpd" type="checkbox" class="checkbox" required wire:model="rgpd"/>
        <label for="rgpd" class="rgpd">J'accepte les <a href="#" class="rgpd" onclick="openPopup()">conditions d'utilisation</a></label>

        <x-input-error :messages="$errors->get('rgpd')" class="mt-2" />
